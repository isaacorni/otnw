    ...
    var p_ind_estado =  'S';
        ...
        $("#grid").kendoGrid({
            ...
            columns: [
                ...
                { field: "btnProcesar", command: { text: "Procesar", click: fn_ProcesarSolicitud }, title: "Procesar", width: "100px" },
            ],
        });
...
function fn_ProcesarSolicitud(e) {
    e.preventDefault();
    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
    if (dataItem.tip_cliente == 'M') {
        var url = '../Creditos/ProcesarSolicitud';
